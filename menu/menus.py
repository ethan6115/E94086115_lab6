...
class BuildMenu(Menu):
    def __init__(self, x, y):
        ...
        """
        self._buttons = [Button(RAPID_TEST_BTN_IMAGE, "rapid test", self.rect.centerx, self.rect.centery - 70),#rapid test
                         Button(PCR_BTN_IMAGE, "pcr", self.rect.centerx, self.rect.centery + 75), #加上pcr按鈕
                         Button(ALCOHOL_BTN_IMAGE, "alcohol", self.rect.centerx-70, self.rect.centery - 5)#加上alcohol按鈕
                         ]
